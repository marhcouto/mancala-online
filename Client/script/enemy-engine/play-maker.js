/*
    This class represents uses the minimax stategy to evaluate the board and generate plays (AI)
*/
...
export class PlayMaker {
    ...
    /**
     * AI algorithm that uses the 
     * precalculation of possible future
     * boards given a depth of turns
     * to choose the best current alternative
     * 
    ...
    static _minimaxAux(gameModel, depth, initialDepth) {
        ...
        for (let i = 0; i < numHouses; i++) {
            ...
            // Calculates current score or keeps looking deeper
